...
(function(a, b) {
  ...
  function bb(a, b, d, e, f) {
    bb._super_.call(this),
      d - a >= 0
        ? ((this.x1 = a), (this.y1 = b), (this.x2 = d), (this.y2 = e))
        : ((this.x1 = d), (this.y1 = e), (this.x2 = a), (this.y2 = b)),
      ...
      (this.direction = c.Util.initValue(f, ">"));
  }
  function ba() {
    (this.vector = new c.Vector2D(0, 0)),
      (this.random = 0),
      (this.crossType = "dead"),
      (this.alert = !0);
  }
  function _(a, b) {
    _._super_.call(this, a, b),
  ...
  function $(a, b, c) {
    $._super_.call(this, a, b),
      (this.context = this.element.getContext("2d")),
      (this.imageData = null),
      (this.rectangle = null),
      (this.rectangle = c),
      this.createImageData(c);
  }
  function Z(a, b) {
    Z._super_.call(this, a, b),
      (this.stroke = null),
      (this.context = this.element.getContext("2d")),
      (this.bufferCache = {});
  }
  ...
  function V(a, b, d) {
    (this.element = d),
      (this.type = c.Util.initValue(a, "canvas")),
      (this.proton = b),
      (this.renderer = this.getRenderer());
  }
  function T(b, d, e) {
    (this.mouseTarget = c.Util.initValue(b, a)),
      (this.ease = c.Util.initValue(d, 0.7)),
      (this._allowEmitting = !1),
      this.initEventHandler(),
      T._super_.call(this, e);
  }
  function S(a) {
  ...
  function R(a) {
    (this.initializes = []),
      ...
      (this.damping = 0.006),
      (this.bindEmitter = !0),
      (this.rate = new c.Rate(1, 0.1)),
      R._super_.call(this, a),
      (this.id = "emitter_" + R.ID++);
  }
  function Q(a, b, d, e) {
    Q._super_.call(this, d, e),
      (this.distanceVec = new c.Vector2D()),
      (this.centerPoint = c.Util.initValue(a, new c.Vector2D())),
      (this.force = c.Util.initValue(this.normalizeValue(b), 100)),
  ...
  function I(a, b, c, d, e) {
    I._super_.call(this, a, b, c, d, e),
      (this.force *= -1),
      (this.name = "Repulsion");
  }
  function H(a, b, c, d, e) {
    H._super_.call(this, d, e),
      this.reset(a, b, c),
      (this.time = 0),
      (this.name = "RandomDrift");
  }
  function G(a, b, d, e, f) {
    G._super_.call(this, e, f),
      (this.targetPosition = c.Util.initValue(a, new c.Vector2D())),
      (this.radius = c.Util.initValue(d, 1e3)),
      (this.force = c.Util.initValue(this.normalizeValue(b), 100)),
      (this.radiusSq = this.radius * this.radius),
      (this.attractionForce = new c.Vector2D()),
      (this.lengthSq = 0),
      (this.name = "Attraction");
  }
  function F(a, b, d, e) {
    F._super_.call(this, d, e),
      (this.force = this.normalizeForce(new c.Vector2D(a, b))),
      (this.name = "Force");
  }
  function E(a, b, d) {
    E._super_.call(this),
      (this.image = this.setSpanValue(a)),
      (this.w = c.Util.initValue(b, 20)),
  ...
  function B(a, b, d) {
    B._super_.call(this),
      (this.rPan = c.Util.setSpanValue(a)),
      (this.thaPan = c.Util.setSpanValue(b)),
  ...
  function x() {}
  function w(a, b) {
    (this.numPan = c.Util.initValue(a, 1)),
      (this.timePan = c.Util.initValue(b, 1)),
      (this.numPan = c.Util.setSpanValue(this.numPan)),
      (this.timePan = c.Util.setSpanValue(this.timePan)),
      (this.startTime = 0),
      (this.nextTime = 0),
      this.init();
  }
  function v(a, b) {
    (this.id = "Behaviour_" + v.id++),
      (this.life = c.Util.initValue(a, Infinity)),
      (this.easing = c.ease.setEasingByName(b)),
      (this.age = 0),
      (this.energy = 1),
      (this.dead = !1),
      (this.parents = []),
  ...
  function r(a, b, d) {
    (this.isArray = !1),
      c.Util.isArray(a)
        ? ((this.isArray = !0), (this.a = a))
        : ((this.a = c.Util.initValue(a, 1)),
          (this.b = c.Util.initValue(b, this.a)),
          (this.center = c.Util.initValue(d, !1)));
  }
  function l(a, b) {
    (this.proParticleCount = c.Util.initValue(a, 0)),
      (this.releaseTime = c.Util.initValue(b, -1)),
      (this.poolList = []),
      (this.timeoutID = 0);
    for (var d = 0; d < this.proParticleCount; d++) this.add();
    this.releaseTime > 0 &&
      (this.timeoutID = setTimeout(this.release, this.releaseTime / 1e3));
  }
  function k(a) {
    (this.id = "particle_" + k.ID++),
      this.reset(!0),
  ...
  function j() {
    ...
    for (var a = 0; a < 20; a++)
      this.mats.push(c.Mat3.create([0, 0, 0, 0, 0, 0, 0, 0, 0]));
  }
  function f(a) {
    (this.type = a.type),
      (this.particle = a.particle),
  ...
  function c(a, b) {
    (this.proParticleCount = c.Util.initValue(a, c.POOL_MAX)),
      (this.integrationType = c.Util.initValue(b, c.EULER)),
      (this.emitters = []),
      (this.renderers = []),
      (this.time = 0),
      (this.oldTime = 0),
      (c.pool = new c.ParticlePool(this.proParticleCount)),
  ...
  (c.POOL_MAX = 1e3),
    ...
    (c.RK4 = "runge-kutta4"),
    (c.VERLET = "verlet"),
    (c.PARTICLE_CREATED = "partilcleCreated"),
    (c.PARTICLE_UPDATE = "partilcleUpdate"),
    (c.PARTICLE_SLEEP = "particleSleep"),
    (c.PARTICLE_DEAD = "partilcleDead"),
    (c.PROTON_UPDATE = "protonUpdate"),
    (c.PROTON_UPDATE_AFTER = "protonUpdateAfter"),
    (c.EMITTER_ADDED = "emitterAdded"),
    (c.EMITTER_REMOVED = "emitterRemoved"),
    (c.amendChangeTabsBug = !0),
    (c.TextureBuffer = {}),
    (c.TextureCanvasBuffer = {}),
    (c.prototype = {
      ...
      addEmitter: function(a) {
        this.emitters.push(a),
          (a.parent = this),
          this.dispatchEvent(
            new c.Event({ type: c.EMITTER_ADDED, emitter: a })
          );
      },
      removeEmitter: function(a) {
        ...
        this.emitters.splice(b, 1),
          (a.parent = null),
          this.dispatchEvent(
            new c.Event({ type: c.EMITTER_REMOVED, emitter: a })
          );
      },
      update: function() {
        this.dispatchEvent(new c.Event({ type: c.PROTON_UPDATE })),
          this.oldTime || (this.oldTime = new Date().getTime());
        var a = new Date().getTime();
        (this.elapsed = (a - this.oldTime) / 1e3),
          c.amendChangeTabsBug && this.amendChangeTabsBug(),
          (this.oldTime = a);
        if (this.elapsed > 0)
          for (var b = 0; b < this.emitters.length; b++)
            this.emitters[b].update(this.elapsed);
        this.dispatchEvent(new c.Event({ type: c.PROTON_UPDATE_AFTER }));
      },
      ...
      destory: function() {
        ...
        for (var b = 0; b < a; b++)
          this.emitters[b].destory(), delete this.emitters[b];
        (this.emitters = []),
          (this.time = 0),
          (this.oldTime = 0),
          c.pool.release();
  ...
  (d.initialize = function(a) {
    (a.addEventListener = e.addEventListener),
      (a.removeEventListener = e.removeEventListener),
    ...
    (c.EventDispatcher = d),
    c.EventDispatcher.initialize(c.prototype),
    (c.Event = f);
  var g = g || {
    ...
    judgeVector2D: function(a) {
      ...
      if (
        ...
        a.hasOwnProperty("ax") ||
        a.hasOwnProperty("a") ||
        a.hasOwnProperty("accelerate")
      )
        b += "a";
      return b;
    },
    setVector2DByObject: function(a, b) {
      b.hasOwnProperty("x") && (a.p.x = b.x),
        b.hasOwnProperty("y") && (a.p.y = b.y),
        b.hasOwnProperty("vx") && (a.v.x = b.vx),
        b.hasOwnProperty("vy") && (a.v.y = b.vy),
        b.hasOwnProperty("ax") && (a.a.x = b.ax),
        b.hasOwnProperty("ay") && (a.a.y = b.ay),
        b.hasOwnProperty("p") && particle.p.copy(b.p),
        b.hasOwnProperty("v") && particle.v.copy(b.v),
        b.hasOwnProperty("a") && particle.a.copy(b.a),
        b.hasOwnProperty("position") && particle.p.copy(b.position),
        b.hasOwnProperty("velocity") && particle.v.copy(b.velocity),
        b.hasOwnProperty("accelerate") && particle.a.copy(b.accelerate);
    },
    addPrototypeByObject: function(a, b, d) {
      for (var e in b)
        d
          ? d.indexOf(e) < 0 && (a[e] = c.Util.getSpanValue(b[e]))
          : (a[e] = c.Util.getSpanValue(b[e]));
      return a;
    },
    ...
    inherits: function(a, b) {
      a._super_ = b;
      if (Object.create)
        a.prototype = Object.create(b.prototype, { constructor: { value: b } });
      else {
        var c = function() {};
    ...
    getImage: function(a, b, c, d) {
      typeof a == "string"
        ? this.loadAndSetImage(a, b, c, d)
        : typeof a == "object"
        ? this.loadAndSetImage(a.src, b, c, d)
        : a instanceof Image && this.loadedImage(a.src, b, c, d, a);
    },
    loadedImage: function(a, b, d, e, f) {
      (b.target = f),
        (b.transform.src = a),
        c.TextureBuffer[a] || (c.TextureBuffer[a] = b.target);
      if (d)
        if (c.TextureCanvasBuffer[a])
          b.transform.canvas = c.TextureCanvasBuffer[a];
        else {
          var g = c.WebGLUtil.nhpot(b.target.width),
            h = c.WebGLUtil.nhpot(b.target.height);
          b.transform.canvas = c.DomUtil.createCanvas("canvas" + a, g, h);
          var i = b.transform.canvas.getContext("2d");
          i.drawImage(b.target, 0, 0, b.target.width, b.target.height),
            (c.TextureCanvasBuffer[a] = b.transform.canvas);
        }
      e && e(b);
    },
    loadAndSetImage: function(a, b, d, e) {
      if (c.TextureBuffer[a]) this.loadedImage(a, b, d, e, c.TextureBuffer[a]);
      else {
        var f = this,
          g = new Image();
        (g.onload = function(c) {
  ...
  (c.DomUtil = i),
    (j.prototype.set = function(a, b) {
      b == 0
        ? c.Mat3.set(a, this.mats[0])
        : c.Mat3.multiply(this.mats[b - 1], a, this.mats[b]),
        (this.size = Math.max(this.size, b + 1));
    }),
    (j.prototype.push = function(a) {
      this.size == 0
        ? c.Mat3.set(a, this.mats[0])
        : c.Mat3.multiply(this.mats[this.size - 1], a, this.mats[this.size]),
        this.size++;
    }),
    ...
    (k.prototype = {
      ...
      reset: function(a) {
        (this.life = Infinity),
          ...
          (this.rotation = 0),
          (this.color = null),
          (this.easing = c.ease.setEasingByName(c.easeLinear)),
          a
            ? ((this.transform = {}),
              (this.p = new c.Vector2D()),
              ...
              (this.behaviours = []))
            : (c.Util.destroyObject(this.transform),
              this.p.set(0, 0),
              this.v.set(0, 0),
              this.a.set(0, 0),
              this.old.p.set(0, 0),
      ...
      addBehaviour: function(a) {
        this.behaviours.push(a),
          a.hasOwnProperty("parents") && a.parents.push(this),
          a.initialize(this);
      },
    ...
    (l.prototype = {
      ...
      release: function() {
        for (var a = 0; a < this.poolList.length; a++)
          this.poolList[a].destory && this.poolList[a].destory(),
  ...
  (o.prototype = {
    ...
    eulerIntegrate: function(a, b, c) {
      a.sleep ||
        (a.old.p.copy(a.p),
        a.old.v.copy(a.v),
        a.a.multiplyScalar(1 / a.mass),
        a.v.add(a.a.multiplyScalar(b)),
        a.p.add(a.old.v.multiplyScalar(b)),
        c && a.v.multiplyScalar(c),
        a.a.clear());
    }
  }),
  ...
  (q.prototype = {
    ...
    (r.prototype = {
      getValue: function(a) {
        return this.isArray
          ...
          : this.center
          ? c.MathUtils.randomFloating(this.a, this.b, a)
          : c.MathUtils.randomAToB(this.a, this.b, a);
      }
    }),
    (c.Span = r),
    (c.getSpan = function(a, b, d) {
      return new c.Span(a, b, d);
    }),
    c.Util.inherits(s, c.Span),
    ...
    (t.prototype = {
      contains: function(a, b) {
        return a <= this.right && a >= this.x && b <= this.bottom && b >= this.y
          ? !0
          : !1;
      }
    }),
  ...
  (c.Mat3 = u),
    ...
    (v.prototype = {
      reset: function(a, b) {
        (this.life = c.Util.initValue(a, Infinity)),
          (this.easing = c.Util.initValue(
            b,
            c.ease.setEasingByName(c.easeLinear)
          ));
      },
      ...
      applyBehaviour: function(a, b, c) {
        ...
        if (this.age >= this.life || this.dead)
          (this.energy = 0), (this.dead = !0), this.destory();
        else {
    ...
    (x.prototype.initialize = function(a) {}),
    (c.Initialize = x);
  var y = {
    initialize: function(a, b, d) {
      var e = d.length,
        f;
      for (f = 0; f < e; f++)
        d[f] instanceof c.Initialize
          ? d[f].init(a, b)
          : c.InitializeUtil.init(a, b, d[f]);
    ...
    bindEmitter: function(a, b) {
      a.bindEmitter &&
        ...
        b.v.add(a.v),
        b.a.add(a.a),
        b.v.rotate(c.MathUtils.degreeTransform(a.rotation)));
    }
  };
  (c.InitializeUtil = y),
    c.Util.inherits(z, c.Initialize),
    (z.prototype.initialize = function(a) {
      this.lifePan.a == Infinity
        ? (a.life = Infinity)
        : (a.life = this.lifePan.getValue());
    }),
    (c.Life = z),
    c.Util.inherits(A, c.Initialize),
    (A.prototype.reset = function(a) {
      this.zone = c.Util.initValue(a, new c.PointZone());
    }),
    (A.prototype.initialize = function(a) {
      this.zone.getPosition(),
        (a.p.x = this.zone.vector.x),
        (a.p.y = this.zone.vector.y);
    }),
    (c.Position = A),
    (c.P = A),
    c.Util.inherits(B, c.Initialize),
    (B.prototype.reset = function(a, b, d) {
      (this.rPan = c.Util.setSpanValue(a)),
        (this.thaPan = c.Util.setSpanValue(b)),
        (this.type = c.Util.initValue(d, "vector"));
    }),
    ...
    (B.prototype.initialize = function(a) {
      if (this.type == "p" || this.type == "P" || this.type == "polar") {
        var b = new c.Polar2D(
          ...
          (this.thaPan.getValue() * Math.PI) / 180
        );
        (a.v.x = b.getX()), (a.v.y = b.getY());
      } else
        (a.v.x = this.normalizeVelocity(this.rPan.getValue())),
          (a.v.y = this.normalizeVelocity(this.thaPan.getValue()));
    }),
    (c.Velocity = B),
    (c.V = B),
    c.Util.inherits(C, c.Initialize),
    (C.prototype.initialize = function(a) {
      a.mass = this.massPan.getValue();
    }),
    (c.Mass = C),
    c.Util.inherits(D, c.Initialize),
    (D.prototype.reset = function(a, b, d) {
    ...
    (c.Radius = D),
    c.Util.inherits(E, c.Initialize),
    (E.prototype.initialize = function(a) {
      var b = this.image.getValue();
      typeof b == "string"
        ? (a.target = { width: this.w, height: this.h, src: b })
        : (a.target = b);
    }),
    ...
    (c.ImageTarget = E),
    c.Util.inherits(F, c.Behaviour),
    (F.prototype.reset = function(a, b, d, e) {
      (this.force = this.normalizeForce(new c.Vector2D(a, b))),
        d && F._super_.prototype.reset.call(this, d, e);
    }),
    (F.prototype.applyBehaviour = function(a, b, c) {
      F._super_.prototype.applyBehaviour.call(this, a, b, c),
        a.a.add(this.force);
    }),
    (c.Force = F),
    (c.F = F),
    c.Util.inherits(G, c.Behaviour),
    (G.prototype.reset = function(a, b, d, e, f) {
      (this.targetPosition = c.Util.initValue(a, new c.Vector2D())),
        (this.radius = c.Util.initValue(d, 1e3)),
        (this.force = c.Util.initValue(this.normalizeValue(b), 100)),
        (this.radiusSq = this.radius * this.radius),
        (this.attractionForce = new c.Vector2D()),
        (this.lengthSq = 0),
        e && G._super_.prototype.reset.call(this, e, f);
    }),
    (G.prototype.applyBehaviour = function(a, b, c) {
      G._super_.prototype.applyBehaviour.call(this, a, b, c),
        this.attractionForce.copy(this.targetPosition),
        this.attractionForce.sub(a.p),
    ...
    (c.Attraction = G),
    c.Util.inherits(H, c.Behaviour),
    (H.prototype.reset = function(a, b, d, e, f) {
      (this.panFoce = new c.Vector2D(a, b)),
        (this.panFoce = this.normalizeForce(this.panFoce)),
        (this.delay = d),
        e && H._super_.prototype.reset.call(this, e, f);
    }),
    (H.prototype.applyBehaviour = function(a, b, d) {
      H._super_.prototype.applyBehaviour.call(this, a, b, d),
        (this.time += b),
        this.time >= this.delay &&
          (a.a.addXY(
            c.MathUtils.randomAToB(-this.panFoce.x, this.panFoce.x),
            c.MathUtils.randomAToB(-this.panFoce.y, this.panFoce.y)
          ),
          (this.time = 0));
    }),
    (c.RandomDrift = H),
    c.Util.inherits(I, c.Attraction),
    (I.prototype.reset = function(a, b, c, d, e) {
      I._super_.prototype.reset.call(this, a, b, c, d, e), (this.force *= -1);
    }),
    (c.Repulsion = I),
    c.Util.inherits(J, c.Force),
    (J.prototype.reset = function(a, b, c) {
      J._super_.prototype.reset.call(this, 0, a, b, c);
    }),
    (c.Gravity = J),
    (c.G = J),
    c.Util.inherits(K, c.Behaviour),
    (K.prototype.reset = function(a, b, d, e, f) {
      (this.emitter = c.Util.initValue(a, null)),
        (this.mass = c.Util.initValue(b, !0)),
        (this.callback = c.Util.initValue(d, null)),
        (this.collisionPool = []),
        (this.delta = new c.Vector2D()),
        e && K._super_.prototype.reset.call(this, e, f);
    }),
    (K.prototype.applyBehaviour = function(a, b, c) {
      var d = this.emitter
          ? this.emitter.particles.slice(c)
          : this.pool.slice(c),
        e,
        f,
        g,
      ...
      for (var k = 0; k < j; k++)
        (e = d[k]),
          e !== a &&
            (this.delta.copy(e.p),
            this.delta.sub(a.p),
            (f = this.delta.lengthSq()),
            (distance = a.radius + e.radius),
            f <= distance * distance &&
              ((g = distance - Math.sqrt(f)),
              (g += 0.5),
              (totalMass = a.mass + e.mass),
              (h = this.mass ? e.mass / totalMass : 0.5),
              (i = this.mass ? a.mass / totalMass : 0.5),
              a.p.add(
                this.delta
                  .clone()
                  .normalize()
              ...
              e.p.add(this.delta.normalize().multiplyScalar(g * i)),
              this.callback && this.callback(a, e)));
    }),
    (c.Collision = K),
    c.Util.inherits(L, c.Behaviour),
    (L.prototype.reset = function(a, b, d, e) {
      (this.zone = a),
        (this.zone.crossType = c.Util.initValue(b, "dead")),
        d && L._super_.prototype.reset.call(this, d, e);
    }),
    (L.prototype.applyBehaviour = function(a, b, c) {
      L._super_.prototype.applyBehaviour.call(this, a, b, c),
        this.zone.crossing(a);
    }),
    (c.CrossZone = L),
    c.Util.inherits(M, c.Behaviour),
    (M.prototype.reset = function(a, d, e, f) {
      d == null || d == b ? (this.same = !0) : (this.same = !1),
        (this.a = c.Util.setSpanValue(c.Util.initValue(a, 1))),
        (this.b = c.Util.setSpanValue(d)),
        e && M._super_.prototype.reset.call(this, e, f);
    }),
    (M.prototype.initialize = function(a) {
      (a.transform.alphaA = this.a.getValue()),
        this.same
          ? (a.transform.alphaB = a.transform.alphaA)
          : (a.transform.alphaB = this.b.getValue());
    }),
    (M.prototype.applyBehaviour = function(a, b, c) {
      M._super_.prototype.applyBehaviour.call(this, a, b, c),
        (a.alpha =
          a.transform.alphaB +
          (a.transform.alphaA - a.transform.alphaB) * this.energy),
        a.alpha < 0.001 && (a.alpha = 0);
    }),
    (c.Alpha = M),
    c.Util.inherits(N, c.Behaviour),
    (N.prototype.reset = function(a, d, e, f) {
      d == null || d == b ? (this.same = !0) : (this.same = !1),
        (this.a = c.Util.setSpanValue(c.Util.initValue(a, 1))),
        (this.b = c.Util.setSpanValue(d)),
        e && N._super_.prototype.reset.call(this, e, f);
    }),
    (N.prototype.initialize = function(a) {
      (a.transform.scaleA = this.a.getValue()),
        (a.transform.oldRadius = a.radius),
        this.same
          ? (a.transform.scaleB = a.transform.scaleA)
          : (a.transform.scaleB = this.b.getValue());
    }),
    (N.prototype.applyBehaviour = function(a, b, c) {
      N._super_.prototype.applyBehaviour.call(this, a, b, c),
        (a.scale =
          a.transform.scaleB +
          (a.transform.scaleA - a.transform.scaleB) * this.energy),
        a.scale < 1e-4 && (a.scale = 0),
        (a.radius = a.transform.oldRadius * a.scale);
    }),
    (c.Scale = N),
    c.Util.inherits(O, c.Behaviour),
    (O.prototype.reset = function(a, d, e, f, g) {
      d == null || d == b ? (this.same = !0) : (this.same = !1),
        (this.a = c.Util.setSpanValue(c.Util.initValue(a, "Velocity"))),
        (this.b = c.Util.setSpanValue(c.Util.initValue(d, 0))),
        (this.style = c.Util.initValue(e, "to")),
        f && O._super_.prototype.reset.call(this, f, g);
    }),
    (O.prototype.initialize = function(a) {
      (a.rotation = this.a.getValue()),
        (a.transform.rotationA = this.a.getValue()),
        this.same || (a.transform.rotationB = this.b.getValue());
    }),
    (O.prototype.applyBehaviour = function(a, b, c) {
      O._super_.prototype.applyBehaviour.call(this, a, b, c);
      if (!this.same)
        this.style == "to" || this.style == "TO" || this.style == "_"
          ? (a.rotation +=
              a.transform.rotationB +
              (a.transform.rotationA - a.transform.rotationB) * this.energy)
          : (a.rotation += a.transform.rotationB);
      else if (this.a.a == "V" || this.a.a == "Velocity" || this.a.a == "v")
        a.rotation = a.getDirection();
    }),
    (c.Rotate = O),
    c.Util.inherits(P, c.Behaviour),
    (P.prototype.reset = function(a, b, c, d) {
      (this.color1 = this.setSpanValue(a)),
        (this.color2 = this.setSpanValue(b)),
        c && P._super_.prototype.reset.call(this, c, d);
    }),
    (P.prototype.initialize = function(a) {
      (a.color = this.color1.getValue()),
        (a.transform.beginRGB = c.Util.hexToRGB(a.color)),
        this.color2 &&
          (a.transform.endRGB = c.Util.hexToRGB(this.color2.getValue()));
    }),
    (P.prototype.applyBehaviour = function(a, b, c) {
      this.color2
        ? (P._super_.prototype.applyBehaviour.call(this, a, b, c),
          (a.transform.rgb.r =
            a.transform.endRGB.r +
            (a.transform.beginRGB.r - a.transform.endRGB.r) * this.energy),
          (a.transform.rgb.g =
            a.transform.endRGB.g +
            (a.transform.beginRGB.g - a.transform.endRGB.g) * this.energy),
          (a.transform.rgb.b =
            a.transform.endRGB.b +
            (a.transform.beginRGB.b - a.transform.endRGB.b) * this.energy),
          (a.transform.rgb.r = parseInt(a.transform.rgb.r, 10)),
          (a.transform.rgb.g = parseInt(a.transform.rgb.g, 10)),
          (a.transform.rgb.b = parseInt(a.transform.rgb.b, 10)))
        : ((a.transform.rgb.r = a.transform.beginRGB.r),
          (a.transform.rgb.g = a.transform.beginRGB.g),
          (a.transform.rgb.b = a.transform.beginRGB.b));
    }),
    (P.prototype.setSpanValue = function(a) {
      return a ? (a instanceof c.ColorSpan ? a : new c.ColorSpan(a)) : null;
    }),
    (c.Color = P),
    c.Util.inherits(Q, c.Behaviour),
    (Q.prototype.reset = function(a, b, d, e) {
      (this.distanceVec = new c.Vector2D()),
        (this.centerPoint = c.Util.initValue(a, new c.Vector2D())),
        (this.force = c.Util.initValue(this.normalizeValue(b), 100)),
        d && Q._super_.prototype.reset.call(this, d, e);
    }),
    (Q.prototype.initialize = function(a) {}),
    (Q.prototype.applyBehaviour = function(a, b, c) {
      this.distanceVec.set(
        this.centerPoint.x - a.p.x,
        this.centerPoint.y - a.p.y
      );
    ...
    (c.GravityWell = Q),
    (R.ID = 0),
    c.Util.inherits(R, c.Particle),
    c.EventDispatcher.initialize(R.prototype),
    (R.prototype.emit = function(a, b) {
      (this.emitTime = 0),
        (this.emitTotalTimes = c.Util.initValue(a, Infinity)),
        b == !0 || b == "life" || b == "destroy"
          ? a == "once"
            ? (this.life = 1)
    ...
    (R.prototype.createParticle = function(a, b) {
      var d = c.pool.get();
      this.setupParticle(d, a, b),
        this.dispatchEvent(
          new c.Event({ type: c.PARTICLE_CREATED, particle: d })
        );
      return d;
    }),
    ...
    (R.prototype.addBehaviour = function() {
      var a = arguments.length,
        b;
      for (b = 0; b < a; b++)
        this.behaviours.push(arguments[b]),
          arguments[b].hasOwnProperty("parents") &&
            arguments[b].parents.push(this);
    }),
    ...
    (R.prototype.integrate = function(a) {
      ...
      for (e = 0; e < d; e++) {
        ...
        f.update(a, e),
          c.integrator.integrate(f, a, b),
          this.dispatchEvent(
            new c.Event({ type: c.PARTICLE_UPDATE, particle: f })
          );
      }
    }),
      ...
      for (e = d - 1; e >= 0; e--)
        (b = this.particles[e]),
          b.dead &&
            ...
            this.dispatchEvent(
              new c.Event({ type: c.PARTICLE_DEAD, particle: b })
            ));
    }),
    (R.prototype.setupParticle = function(a, b, d) {
      var e = this.initializes,
        f = this.behaviours;
      b && (b instanceof Array ? (e = b) : (e = [b])),
        d && (d instanceof Array ? (f = d) : (f = [d])),
        c.InitializeUtil.initialize(this, a, e),
        a.addBehaviours(f),
        (a.parent = this),
    ...
    (c.Emitter = R),
    c.Util.inherits(S, c.Emitter),
    (S.prototype.addSelfBehaviour = function() {
      var a = arguments.length,
        b;
    ...
    (c.BehaviourEmitter = S),
    c.Util.inherits(T, c.Emitter),
    (T.prototype.initEventHandler = function() {
      var a = this;
    ...
    (T.prototype.mousemove = function(a) {
      if (a.layerX || a.layerX == 0)
        (this.p.x += (a.layerX - this.p.x) * this.ease),
          (this.p.y += (a.layerY - this.p.y) * this.ease);
      else if (a.offsetX || a.offsetX == 0)
        (this.p.x += (a.offsetX - this.p.x) * this.ease),
          (this.p.y += (a.offsetY - this.p.y) * this.ease);
      this._allowEmitting && T._super_.prototype.emit.call(this, "once");
    }),
    (T.prototype.destroy = function() {
      T._super_.prototype.destroy.call(this),
  ...
  (c.ease = U),
    (c.easeLinear = "easeLinear"),
    (c.easeInQuad = "easeInQuad"),
    (c.easeOutQuad = "easeOutQuad"),
    (c.easeInOutQuad = "easeInOutQuad"),
    (c.easeInCubic = "easeInCubic"),
    (c.easeOutCubic = "easeOutCubic"),
    (c.easeInOutCubic = "easeInOutCubic"),
    (c.easeInQuart = "easeInQuart"),
    (c.easeOutQuart = "easeOutQuart"),
    (c.easeInOutQuart = "easeInOutQuart"),
    (c.easeInSine = "easeInSine"),
    (c.easeOutSine = "easeOutSine"),
    (c.easeInOutSine = "easeInOutSine"),
    (c.easeInExpo = "easeInExpo"),
    (c.easeOutExpo = "easeOutExpo"),
    (c.easeInOutExpo = "easeInOutExpo"),
    (c.easeInCirc = "easeInCirc"),
    (c.easeOutCirc = "easeOutCirc"),
    (c.easeInOutCirc = "easeInOutCirc"),
    (c.easeInBack = "easeInBack"),
    (c.easeOutBack = "easeOutBack"),
    (c.easeInOutBack = "easeInOutBack"),
    (V.prototype = {
      start: function() {
    ...
    (c.BaseRender = W),
    c.Util.inherits(X, c.BaseRender),
    (X.prototype.start = function() {
      X._super_.prototype.start.call(this);
    }),
    (X.prototype.setStroke = function(a, b) {
      (a = c.Util.initValue(a, "#000000")),
        (b = c.Util.initValue(b, 1)),
        (this.stroke = { color: a, thinkness: b });
    }),
    (X.prototype.onProtonUpdate = function() {}),
    (X.prototype.onParticleCreated = function(a) {
      if (a.target) {
        var b = this;
        ...
        (a.transform.canvas = c.DomUtil.createCanvas(
          a.id + "_canvas",
          a.radius + 1,
          a.radius + 1,
          "absolute"
        )),
          (a.transform.bakOldRadius = a.radius),
          this.stroke
            ? ((a.transform.canvas.width =
                2 * a.radius + this.stroke.thinkness * 2),
              (a.transform.canvas.height =
                2 * a.radius + this.stroke.thinkness * 2))
            : ((a.transform.canvas.width = 2 * a.radius + 1),
              (a.transform.canvas.height = 2 * a.radius + 1)),
          (a.transform.context = a.transform.canvas.getContext("2d")),
          (a.transform.context.fillStyle = a.color),
          a.transform.context.beginPath(),
          a.transform.context.arc(
            a.radius,
            a.radius,
            a.radius,
            0,
          ...
          this.stroke &&
            ((a.transform.context.strokeStyle = this.stroke.color),
            (a.transform.context.lineWidth = this.stroke.thinkness),
            a.transform.context.stroke()),
          a.transform.context.closePath(),
          a.transform.context.fill(),
          this.element.appendChild(a.transform.canvas);
    }),
    (X.prototype.onParticleUpdate = function(a) {
      a.target
        ? a.target instanceof Image &&
          ((a.transform.canvas.style.opacity = a.alpha),
          c.DomUtil.transformDom(
            a.transform.canvas,
            a.p.x - a.target.width / 2,
            a.p.y - a.target.height / 2,
            a.scale,
            a.rotation
          ))
        : ((a.transform.canvas.style.opacity = a.alpha),
          a.transform.oldRadius
            ? c.DomUtil.transformDom(
                a.transform.canvas,
                a.p.x - a.transform.oldRadius,
                a.p.y - a.transform.oldRadius,
                a.scale,
                a.rotation
              )
            : c.DomUtil.transformDom(
                a.transform.canvas,
                a.p.x - a.transform.bakOldRadius,
                a.p.y - a.transform.bakOldRadius,
                a.scale,
                a.rotation
              ));
    }),
    ...
    (c.DomRender = X),
    c.Util.inherits(Y, c.BaseRender),
    (Y.prototype.resize = function(a, b) {}),
    (Y.prototype.start = function() {
      Y._super_.prototype.start.call(this);
    }),
    (Y.prototype.onProtonUpdate = function() {}),
    (Y.prototype.onParticleCreated = function(a) {
      if (a.target)
        (a.target = a.target.clone()),
          a.target.parent ||
            (!a.target.image ||
              ((a.target.regX = a.target.image.width / 2),
              (a.target.regY = a.target.image.height / 2)),
            this.element.addChild(a.target));
      else {
        var b = new createjs.Graphics();
        this.stroke &&
          (this.stroke == !0
            ? b.beginStroke("#000000")
            : this.stroke instanceof String && b.beginStroke(this.stroke)),
    ...
    (Y.prototype.onParticleUpdate = function(a) {
      a.target &&
        ((a.target.x = a.p.x),
        (a.target.y = a.p.y),
        (a.target.alpha = a.alpha),
        (a.target.scaleX = a.target.scaleY = a.scale),
    ...
    (c.EaselRender = Y),
    c.Util.inherits(Z, c.BaseRender),
    (Z.prototype.resize = function(a, b) {
    ...
    (Z.prototype.onParticleCreated = function(a) {
      a.target
        ? c.Util.getImage(a.target, a, !1)
        : (a.color = a.color ? a.color : "#ff0000");
    }),
    (Z.prototype.onParticleUpdate = function(a) {
      if (a.target) {
        if (a.target instanceof Image) {
          var b = (a.target.width * a.scale) | 0,
            d = (a.target.height * a.scale) | 0,
            e = a.p.x - b / 2,
            f = a.p.y - d / 2;
          if (!a.color)
            this.context.save(),
              (this.context.globalAlpha = a.alpha),
              this.context.translate(a.p.x, a.p.y),
              this.context.rotate(c.MathUtils.degreeTransform(a.rotation)),
              this.context.translate(-a.p.x, -a.p.y),
            ...
            a.transform.buffer ||
              (a.transform.buffer = this.getBuffer(a.target));
            var g = a.transform.buffer.getContext("2d");
            g.clearRect(
              0,
              0,
              a.transform.buffer.width,
              a.transform.buffer.height
            ),
              (g.globalAlpha = a.alpha),
              g.drawImage(a.target, 0, 0),
              (g.globalCompositeOperation = "source-atop"),
              (g.fillStyle = c.Util.rgbToHex(a.transform.rgb)),
              g.fillRect(
                0,
                0,
                a.transform.buffer.width,
        ...
        a.transform.rgb
          ...
          this.context.arc(a.p.x, a.p.y, a.radius, 0, Math.PI * 2, !0),
          this.stroke &&
    ...
    (Z.prototype.onParticleDead = function(a) {}),
    (Z.prototype.getBuffer = function(a) {
      if (a instanceof Image) {
        var b = a.width + "_" + a.height,
          c = this.bufferCache[b];
        c ||
    ...
    ($.prototype.createImageData = function(a) {
      a
        ? (this.rectangle = a)
        : (this.rectangle = new c.Rectangle(
            0,
            0,
            this.element.width,
            this.element.height
    ...
    ($.prototype.onParticleCreated = function(a) {}),
    ($.prototype.onParticleUpdate = function(a) {
      this.imageData &&
        this.setPixel(
          this.imageData,
          Math.floor(a.p.x - this.rectangle.x),
          Math.floor(a.p.y - this.rectangle.y),
          a
        );
    }),
    ($.prototype.setPixel = function(a, b, c, d) {
      ...
      if (
        !(b < 0 || b > this.element.width || c < 0 || c > this.elementwidth)
      ) {
        var f = ((c >> 0) * a.width + (b >> 0)) * 4;
        (a.data[f] = e.r),
          (a.data[f + 1] = e.g),
          (a.data[f + 2] = e.b),
          (a.data[f + 3] = d.alpha * 255);
      }
    }),
    ($.prototype.onParticleDead = function(a) {}),
    (c.PixelRender = $),
    c.Util.inherits(_, c.BaseRender),
    ...
    (_.prototype.initVar = function() {
      (this.mstack = new c.MStack()),
        (this.umat = c.Mat3.create([2, 0, 1, 0, -2, 0, -1, 1, 1])),
        (this.smat = c.Mat3.create([0.01, 0, 1, 0, 0.01, 0, 0, 0, 1])),
        (this.texturebuffers = {});
    }),
    (_.prototype.start = function() {
      _._super_.prototype.start.call(this),
    ...
    (_.prototype.initShaders = function() {
      var a = this.getShader(this.gl, this.getFragmentShader(), !0),
        b = this.getShader(this.gl, this.getVertexShader(), !1);
      (this.sprogram = this.gl.createProgram()),
        this.gl.attachShader(this.sprogram, b),
        this.gl.attachShader(this.sprogram, a),
        this.gl.linkProgram(this.sprogram),
        this.gl.getProgramParameter(this.sprogram, this.gl.LINK_STATUS) ||
    ...
    (_.prototype.createCircle = function(a) {
      ...
      var b = c.DomUtil.createCanvas(
          "circle_canvas",
          this.circleCanvasRadius * 2,
          this.circleCanvasRadius * 2
        ),
        d = b.getContext("2d");
      d.beginPath(),
    ...
    (_.prototype.setImgInCanvas = function(a) {
      var b = a.target.width,
        d = a.target.height,
        e = c.WebGLUtil.nhpot(a.target.width),
        f = c.WebGLUtil.nhpot(a.target.height),
        g = a.target.width / e,
        h = a.target.height / f;
      this.texturebuffers[a.transform.src] ||
        (this.texturebuffers[a.transform.src] = [
          this.gl.createTexture(),
          this.gl.createBuffer(),
          this.gl.createBuffer()
        ]),
        (a.transform.texture = this.texturebuffers[a.transform.src][0]),
        (a.transform.vcBuffer = this.texturebuffers[a.transform.src][1]),
        (a.transform.tcBuffer = this.texturebuffers[a.transform.src][2]),
        this.gl.bindBuffer(this.gl.ARRAY_BUFFER, a.transform.tcBuffer),
        this.gl.bufferData(
          this.gl.ARRAY_BUFFER,
          new Float32Array([0, 0, g, 0, 0, h, h, h]),
          this.gl.STATIC_DRAW
        ),
        this.gl.bindBuffer(this.gl.ARRAY_BUFFER, a.transform.vcBuffer),
        this.gl.bufferData(
          this.gl.ARRAY_BUFFER,
          new Float32Array([0, 0, b, 0, 0, d, b, d]),
          this.gl.STATIC_DRAW
        );
      var i = a.transform.canvas.getContext("2d"),
        j = i.getImageData(0, 0, e, f);
      this.gl.bindTexture(this.gl.TEXTURE_2D, a.transform.texture),
        this.gl.texImage2D(
          this.gl.TEXTURE_2D,
          0,
          this.gl.RGBA,
        ...
        (a.transform.textureLoaded = !0),
        (a.transform.textureWidth = b),
        (a.transform.textureHeight = d);
    }),
    (_.prototype.setStroke = function(a, b) {}),
    (_.prototype.onProtonUpdate = function() {}),
    (_.prototype.onParticleCreated = function(a) {
      var b = this;
      (a.transform.textureLoaded = !1),
        (a.transform.tmat = c.Mat3.create()),
        (a.transform.tmat[8] = 1),
        (a.transform.imat = c.Mat3.create()),
        (a.transform.imat[8] = 1),
        a.target
          ? c.Util.getImage(a.target, a, !0, function(a) {
              b.setImgInCanvas.call(b, a), (a.transform.oldScale = 1);
            })
          : c.Util.getImage(this.circleCanvasURL, a, !0, function(a) {
              b.setImgInCanvas.call(b, a),
                (a.transform.oldScale = a.radius / b.circleCanvasRadius);
            });
    }),
    (_.prototype.onParticleUpdate = function(a) {
      a.transform.textureLoaded &&
        (this.updateMatrix(a),
        this.gl.uniform3f(
          this.sprogram.color,
          a.transform.rgb.r / 255,
          a.transform.rgb.g / 255,
          a.transform.rgb.b / 255
        ),
    ...
    (_.prototype.onParticleDead = function(a) {}),
    (_.prototype.updateMatrix = function(a) {
      var b = c.WebGLUtil.makeTranslation(
          -a.transform.textureWidth / 2,
          -a.transform.textureHeight / 2
        ),
        d = c.WebGLUtil.makeTranslation(a.p.x, a.p.y),
        e = a.rotation * (Math.PI / 180),
        f = c.WebGLUtil.makeRotation(e),
        g = a.scale * a.transform.oldScale,
        h = c.WebGLUtil.makeScale(g, g),
        i = c.WebGLUtil.matrixMultiply(b, h);
      (i = c.WebGLUtil.matrixMultiply(i, f)),
        (i = c.WebGLUtil.matrixMultiply(i, d)),
        c.Mat3.inverse(i, a.transform.imat),
        (i[2] = a.alpha),
        this.mstack.push(i);
    }),
    (c.WebGLRender = _),
    (ba.prototype = { getPosition: function() {}, crossing: function(a) {} }),
    (c.Zone = ba),
    c.Util.inherits(bb, c.Zone),
    ...
    (bb.prototype.getSymmetric = function(a) {
      var b = a.getGradient(),
        ...
        e = a.x,
        f = a.y;
      (a.x = e * Math.cos(d) - f * Math.sin(d)),
        (a.y = e * Math.sin(d) + f * Math.cos(d));
      return a;
    }),
    ...
    (bb.prototype.getRange = function(a, b) {
      ...
      c <= Math.PI / 4
        ? a.p.x < this.maxx && a.p.x > this.minx && b()
        : a.p.y < this.maxy && a.p.y > this.miny && b();
    }),
    ...
    (bb.prototype.crossing = function(a) {
      ...
      this.crossType == "dead"
        ...
        : this.crossType == "bound"
        ? this.getRange(a, function() {
            b.getDistance(a.p.x, a.p.y) <= a.radius &&
              (b.dx == 0
                ? (a.v.x *= -1)
                : b.dy == 0
                ? (a.v.y *= -1)
        ...
        : this.crossType == "cross" &&
          this.alert &&
          (alert("Sorry lineZone does not support cross method"),
          (this.alert = !1));
    }),
    (c.LineZone = bb),
    c.Util.inherits(bc, c.Zone),
    (bc.prototype.getPosition = function() {
      (this.random = Math.random()),
    ...
    (bc.prototype.crossing = function(a) {
      ...
      this.crossType == "dead"
        ? b - a.radius > this.radius && (a.dead = !0)
        : this.crossType == "bound"
        ? b + a.radius >= this.radius && this.getSymmetric(a)
        : this.crossType == "cross" &&
          this.alert &&
    ...
    (bc.prototype.getSymmetric = function(a) {
      var b = a.v.getGradient(),
        ...
        e = a.v.x,
        f = a.v.y;
      (a.v.x = e * Math.cos(d) - f * Math.sin(d)),
        (a.v.y = e * Math.sin(d) + f * Math.cos(d));
    }),
    (bc.prototype.getGradient = function(a) {
      return (
        -Math.PI / 2 + Math.atan2(a.p.y - this.center.y, a.p.x - this.center.x)
      );
    }),
    (c.CircleZone = bc),
    c.Util.inherits(bd, c.Zone),
    (bd.prototype.getPosition = function() {
    ...
    (be.prototype.crossing = function(a) {
      this.crossType == "dead"
        ? (a.p.x + a.radius < this.x
            ? (a.dead = !0)
            : a.p.x - a.radius > this.x + this.width && (a.dead = !0),
          a.p.y + a.radius < this.y
            ? (a.dead = !0)
            : a.p.y - a.radius > this.y + this.height && (a.dead = !0))
        : this.crossType == "bound"
        ? (a.p.x - a.radius < this.x
            ? ((a.p.x = this.x + a.radius), (a.v.x *= -1))
            : a.p.x + a.radius > this.x + this.width &&
              ((a.p.x = this.x + this.width - a.radius), (a.v.x *= -1)),
          a.p.y - a.radius < this.y
            ? ((a.p.y = this.y + a.radius), (a.v.y *= -1))
            : a.p.y + a.radius > this.y + this.height &&
              ((a.p.y = this.y + this.height - a.radius), (a.v.y *= -1)))
        : this.crossType == "cross" &&
          (a.p.x + a.radius < this.x && a.v.x <= 0
            ? (a.p.x = this.x + this.width + a.radius)
            : a.p.x - a.radius > this.x + this.width &&
              a.v.x >= 0 &&
              (a.p.x = this.x - a.radius),
          a.p.y + a.radius < this.y && a.v.y <= 0
            ? (a.p.y = this.y + this.height + a.radius)
            : a.p.y - a.radius > this.y + this.height &&
              a.v.y >= 0 &&
              (a.p.y = this.y - a.radius));
    }),
    (c.RectZone = be),
    c.Util.inherits(bf, c.Zone),
    (bf.prototype.reset = function(a, b, d, e) {
      (this.imageData = a),
        (this.x = c.Util.initValue(b, 0)),
        (this.y = c.Util.initValue(d, 0)),
        (this.d = c.Util.initValue(e, 2)),
        (this.vectors = []),
        this.setVectors();
    }),
    (bf.prototype.setVectors = function() {
      var a,
        ...
        d = this.imageData.height;
      for (a = 0; a < c; a += this.d)
        for (b = 0; b < d; b += this.d) {
          var e = ((b >> 0) * c + (a >> 0)) * 4;
          this.imageData.data[e + 3] > 0 &&
            this.vectors.push({ x: a + this.x, y: b + this.y });
        }
      return this.vector;
    }),
    ...
    (bf.prototype.crossing = function(a) {
      this.crossType == "dead"
        ? this.getBound(a.p.x - this.x, a.p.y - this.y)
          ? (a.dead = !0)
          : (a.dead = !1)
        : this.crossType == "bound" &&
          (this.getBound(a.p.x - this.x, a.p.y - this.y) || a.v.negate());
    }),
    (c.ImageZone = bf);
  var bg = function() {
  ...
  var bh = bh || {
    ...
    drawZone: function(a, b, d, e) {
      ...
      this.addEventListener(a, function() {
        e && f.clearRect(0, 0, b.width, b.height),
          d instanceof c.PointZone
            ? (f.beginPath(),
              (f.fillStyle = g),
              f.arc(d.x, d.y, 10, 0, Math.PI * 2, !0),
              f.fill(),
              f.closePath())
            : d instanceof c.LineZone
            ? (f.beginPath(),
              (f.strokeStyle = g),
              f.moveTo(d.x1, d.y1),
              f.lineTo(d.x2, d.y2),
              f.stroke(),
              f.closePath())
            : d instanceof c.RectZone
            ? (f.beginPath(),
              (f.strokeStyle = g),
              f.drawRect(d.x, d.y, d.width, d.height),
              f.stroke(),
              f.closePath())
            : d instanceof c.CircleZone &&
              (f.beginPath(),
              (f.strokeStyle = g),
              f.arc(d.x, d.y, d.radius, 0, Math.PI * 2, !0),
              f.stroke(),
              f.closePath());
      });
    },
    drawEmitter: function(a, b, c, d) {
      var e = b.getContext("2d"),
        f = this.setStyle();
      this.addEventListener(a, function() {
        d && e.clearRect(0, 0, b.width, b.height),
          e.beginPath(),
          (e.fillStyle = f),
          e.arc(c.p.x, c.p.y, 10, 0, Math.PI * 2, !0),
          e.fill(),
          e.closePath();
      });
    },
