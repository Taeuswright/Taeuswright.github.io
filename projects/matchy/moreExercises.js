var data = {
  results: [
    ...
    },
    {
      ...
      numberOfLegs: 4,
      says: "ribbit",
      matches: ["whale", "cat", "pig", "rabbit"]
    },
    {
      animal: "dog",
      numberOfLegs: 4,
      says: "woof",
      matches: ["dog", "fish", "pig"]
    },
    {
      animal: "human",
      numberOfLegs: 2,
      says: "hello",
      matches: ["frog", "duck", "pig"]
    },
    {
      animal: "fish",
      numberOfLegs: 0,
      says: "blub",
      matches: ["dog", "rabbit", "frog", "human"]
    },
    {
      animal: "whale",
      numberOfLegs: 0,
      says: "aaarrrhhh",
      matches: ["duck", "fish", "pig"]
    },
    {
      animal: "duck",
      numberOfLegs: 2,
      says: "quack",
      matches: ["fish", "human", "chicken", "whale"]
    }
  ]
};
